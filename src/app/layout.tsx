...
export const metadata: Metadata = {
  title:
    "Research Tools — ระบบจัดการเอกสารและบันทึกการขออนุญาตใช้เครื่องมือวิจัย",
  description:
    "ระบบจัดการเอกสารและบันทึกการขออนุญาตใช้เครื่องมือวิจัย คณะพยาบาลศาสตร์ มหาวิทยาลัยเชียงใหม่",
};
